...
const scanStringInputSanitization = require('../lib/stringSanitization');
const scanCorsConfiguration = require('../lib/corsConfig');
const scanAuthentication = require('../lib/authentication');
const scanAuthorization = require('../lib/authorization');
